...
pub fn main(
   ...
   return proc_macro::TokenStream::from(match info.variant {
      EntrypointReturnType::Void    => quote::quote! {
         nusion_lib::__build_entry!(#ident, void, #(#allow_list),*);
         #func
      },
      EntrypointReturnType::Static  => quote::quote! {
         nusion_lib::__build_entry!(#ident, result_static, #(#allow_list),*);
         #func
      },
      EntrypointReturnType::Dynamic => quote::quote! {
         nusion_lib::__build_entry!(#ident, result_dynamic, #(#allow_list),*);
         #func
      },
   });
}
